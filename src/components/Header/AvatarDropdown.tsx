...
export default function AvatarDropdown({accountAddress = ''}) {
                  ...
                  <div className="relative grid grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                    <div className="flex items-center space-x-3">
                      ...
                      <div className="flex-grow">
                        ...
                        <p className="text-xs mt-0.5">{`${accountAddress?.slice(0, 14)}...${accountAddress?.slice(accountAddress.length - 4)}`}</p>
                      </div>
                    </div>
